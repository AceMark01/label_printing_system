  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] print:bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col min-h-screen print:block">
        <MobileHeader />
        <main className="flex-1 lg:pl-[300px] pb-40 lg:pb-32 pt-6 sm:pt-10 bg-slate-50/10 print:p-0 print:m-0 print:bg-white print:block">
          <div className="w-full print:max-w-none print:m-0 print:block">
            {children}
          </div>
        </main>
      </div>
