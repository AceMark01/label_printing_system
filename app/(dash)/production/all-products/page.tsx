...
export default function ProductionAllProducts() {
  ...
  return (
    <div className="flex flex-col gap-0 animate-in fade-in slide-in-from-bottom-2 duration-700 pb-48">
      ...
      <div className="sticky top-0 z-40 bg-slate-50/95 backdrop-blur-md pt-6 pb-4 px-4 sm:px-10 lg:px-12 border-b border-slate-200/60 flex flex-col lg:flex-row items-center gap-4 shadow-sm transition-all">
      ...
      <div className="hidden lg:block bg-white border-b border-slate-200 shadow-sm overflow-x-auto transition-all duration-500">
